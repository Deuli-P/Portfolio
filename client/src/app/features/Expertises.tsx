...
const Card = ({ title, subtitle, icon, text }: Expertise) => {
  return (
    <article className="p-4 bg-primary text-secondary border-2 border-secondary shadow-lg backdrop-blur-2xl relative w-[350px] md:h-[300px] sm:max-w-[90%]">
      {/* TOP */}
...
const Expertises = () => {
  ...
  return (
    <section id="skills" ref={ref} className=" md:pb-22 pb-14" >
