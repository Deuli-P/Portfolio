        ...
        >
            <div className='relative'>
                ...
                >
                    <Image
                        ...
                        quality={95}
                        priority
                        className= ' -translate-y-4 md:tranlate-y-0 md:w-full  md:object-cover '
                    />
                </motion.div>
                <motion.span 
            ...
            <div className='mt-10 '>
                <motion.h1
                    ...
                    >
                        <span className='font-normal md:'>Salut, moi c'est </span>{data.prenom}.<br/>
                        <span className='font-normal '>Je suis</span> {data.profession}<br/>
